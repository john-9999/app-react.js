...
export function TaskContextProvider(props) {
  ...
  function deleteTask(taskId) {
    ...
    ); /*FILTRAMOS,si la tarea es distinta del valor que está seleccionando el usuario se deja y si es igual se saca, true o false = true (se deja) false(se elimina) */
  }
